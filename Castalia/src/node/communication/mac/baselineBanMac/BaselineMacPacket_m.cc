...
EXECUTE_ON_STARTUP(
    ...
    e->insert(RELAY_REQUEST, "RELAY_REQUEST");
    e->insert(RELAY_ACCEPT, "RELAY_ACCEPT");
    e->insert(RELAY_REFUSE, "RELAY_REFUSE");
);
...
void BaselineMacPacket::copy(const BaselineMacPacket& other)
{
    ...
    this->BANSecurity_var = other.BANSecurity_var;
    ...
    this->lastFrame_var = other.lastFrame_var;
    this->fragmentNumber_var = other.fragmentNumber_var;
    this->nonFinalFragment_var = other.nonFinalFragment_var;
...
void BaselineMacPacket::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->BANSecurity_var);
    ...
    doPacking(b,this->lastFrame_var);
    doPacking(b,this->fragmentNumber_var);
    doPacking(b,this->nonFinalFragment_var);
...
void BaselineMacPacket::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->BANSecurity_var);
    ...
    doUnpacking(b,this->lastFrame_var);
    doUnpacking(b,this->fragmentNumber_var);
    doUnpacking(b,this->nonFinalFragment_var);
    doUnpacking(b,this->reserved_var);
}

int BaselineMacPacket::getBAN() const
{
    return BAN_var;
}

void BaselineMacPacket::setBAN(int BAN)
{
    this->BAN_var = BAN;
}
...
int BaselineMacPacket::getBANSecurity() const
{
    return BANSecurity_var;
}

void BaselineMacPacket::setBANSecurity(int BANSecurity)
{
    this->BANSecurity_var = BANSecurity;
}
...
int BaselineMacPacket::getLastFrame() const
{
    return lastFrame_var;
}

void BaselineMacPacket::setLastFrame(int lastFrame)
{
    this->lastFrame_var = lastFrame;
}
...
int BaselineMacPacket::getNonFinalFragment() const
{
    return nonFinalFragment_var;
}

void BaselineMacPacket::setNonFinalFragment(int nonFinalFragment)
{
    this->nonFinalFragment_var = nonFinalFragment;
}

int BaselineMacPacket::getReserved() const
{
    return reserved_var;
}

void BaselineMacPacket::setReserved(int reserved)
{
...
int BaselineMacPacketDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='B' && strcmp(fieldName, "BAN")==0) return base+0;
    if (fieldName[0]=='p' && strcmp(fieldName, "protocolVersion")==0) return base+1;
    ...
    if (fieldName[0]=='B' && strcmp(fieldName, "BANSecurity")==0) return base+5;
    if (fieldName[0]=='f' && strcmp(fieldName, "firstFrame")==0) return base+6;
    if (fieldName[0]=='f' && strcmp(fieldName, "frameSubtype")==0) return base+7;
    if (fieldName[0]=='f' && strcmp(fieldName, "frameType")==0) return base+8;
    if (fieldName[0]=='m' && strcmp(fieldName, "moreData")==0) return base+9;
    if (fieldName[0]=='l' && strcmp(fieldName, "lastFrame")==0) return base+10;
    if (fieldName[0]=='f' && strcmp(fieldName, "fragmentNumber")==0) return base+11;
    if (fieldName[0]=='n' && strcmp(fieldName, "nonFinalFragment")==0) return base+12;
    if (fieldName[0]=='r' && strcmp(fieldName, "reserved")==0) return base+13;
...
std::string BaselineMacPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    BaselineMacPacket *pp = (BaselineMacPacket *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getBAN());
        case 1: return long2string(pp->getProtocolVersion());
        ...
        case 5: return long2string(pp->getBANSecurity());
        case 6: return long2string(pp->getFirstFrame());
        case 7: return long2string(pp->getFrameSubtype());
        case 8: return long2string(pp->getFrameType());
        case 9: return long2string(pp->getMoreData());
        case 10: return long2string(pp->getLastFrame());
        case 11: return long2string(pp->getFragmentNumber());
        case 12: return long2string(pp->getNonFinalFragment());
        case 13: return long2string(pp->getReserved());
        default: return "";
    }
}
...
bool BaselineMacPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    BaselineMacPacket *pp = (BaselineMacPacket *)object; (void)pp;
    switch (field) {
        case 0: pp->setBAN(string2long(value)); return true;
        case 1: pp->setProtocolVersion(string2long(value)); return true;
        ...
        case 5: pp->setBANSecurity(string2long(value)); return true;
        case 6: pp->setFirstFrame(string2long(value)); return true;
        case 7: pp->setFrameSubtype(string2long(value)); return true;
        case 8: pp->setFrameType(string2long(value)); return true;
        case 9: pp->setMoreData(string2long(value)); return true;
        case 10: pp->setLastFrame(string2long(value)); return true;
        case 11: pp->setFragmentNumber(string2long(value)); return true;
        case 12: pp->setNonFinalFragment(string2long(value)); return true;
        case 13: pp->setReserved(string2long(value)); return true;
...
Register_Class(BaselineRelayRequestPacket);

BaselineRelayRequestPacket::BaselineRelayRequestPacket(const char *name, int kind) : ::BaselineMacPacket(name,kind)
{
    this->recipientAddress_var = 0;
    this->senderAddress_var = 0;
    this->formerRelayAddress_var = 0;
    this->RSSI_var = 0;
}

BaselineRelayRequestPacket::BaselineRelayRequestPacket(const BaselineRelayRequestPacket& other) : ::BaselineMacPacket(other)
{
    copy(other);
}

BaselineRelayRequestPacket::~BaselineRelayRequestPacket()
{
}

BaselineRelayRequestPacket& BaselineRelayRequestPacket::operator=(const BaselineRelayRequestPacket& other)
{
    if (this==&other) return *this;
    ::BaselineMacPacket::operator=(other);
    copy(other);
...
void BaselineRelayRequestPacket::copy(const BaselineRelayRequestPacket& other)
{
    this->recipientAddress_var = other.recipientAddress_var;
    this->senderAddress_var = other.senderAddress_var;
    this->formerRelayAddress_var = other.formerRelayAddress_var;
    this->RSSI_var = other.RSSI_var;
}

void BaselineRelayRequestPacket::parsimPack(cCommBuffer *b)
{
    ::BaselineMacPacket::parsimPack(b);
    doPacking(b,this->recipientAddress_var);
    doPacking(b,this->senderAddress_var);
    doPacking(b,this->formerRelayAddress_var);
    doPacking(b,this->RSSI_var);
}

void BaselineRelayRequestPacket::parsimUnpack(cCommBuffer *b)
{
    ::BaselineMacPacket::parsimUnpack(b);
    doUnpacking(b,this->recipientAddress_var);
    doUnpacking(b,this->senderAddress_var);
    doUnpacking(b,this->formerRelayAddress_var);
    doUnpacking(b,this->RSSI_var);
}

int BaselineRelayRequestPacket::getRecipientAddress() const
{
    return recipientAddress_var;
}

void BaselineRelayRequestPacket::setRecipientAddress(int recipientAddress)
{
    this->recipientAddress_var = recipientAddress;
}

int BaselineRelayRequestPacket::getSenderAddress() const
{
    return senderAddress_var;
}

void BaselineRelayRequestPacket::setSenderAddress(int senderAddress)
{
    this->senderAddress_var = senderAddress;
}

int BaselineRelayRequestPacket::getFormerRelayAddress() const
{
    return formerRelayAddress_var;
}

void BaselineRelayRequestPacket::setFormerRelayAddress(int formerRelayAddress)
{
    this->formerRelayAddress_var = formerRelayAddress;
}

int BaselineRelayRequestPacket::getRSSI() const
{
    return RSSI_var;
}

void BaselineRelayRequestPacket::setRSSI(int RSSI)
{
    this->RSSI_var = RSSI;
}

class BaselineRelayRequestPacketDescriptor : public cClassDescriptor
{
  public:
    BaselineRelayRequestPacketDescriptor();
    virtual ~BaselineRelayRequestPacketDescriptor();
...
Register_ClassDescriptor(BaselineRelayRequestPacketDescriptor);

BaselineRelayRequestPacketDescriptor::BaselineRelayRequestPacketDescriptor() : cClassDescriptor("BaselineRelayRequestPacket", "BaselineMacPacket")
{
}

BaselineRelayRequestPacketDescriptor::~BaselineRelayRequestPacketDescriptor()
{
}

bool BaselineRelayRequestPacketDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<BaselineRelayRequestPacket *>(obj)!=NULL;
}

const char *BaselineRelayRequestPacketDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int BaselineRelayRequestPacketDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 4+basedesc->getFieldCount(object) : 4;
}

unsigned int BaselineRelayRequestPacketDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *BaselineRelayRequestPacketDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int BaselineRelayRequestPacketDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='r' && strcmp(fieldName, "recipientAddress")==0) return base+0;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderAddress")==0) return base+1;
    if (fieldName[0]=='f' && strcmp(fieldName, "formerRelayAddress")==0) return base+2;
    if (fieldName[0]=='R' && strcmp(fieldName, "RSSI")==0) return base+3;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}

const char *BaselineRelayRequestPacketDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *BaselineRelayRequestPacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int BaselineRelayRequestPacketDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    BaselineRelayRequestPacket *pp = (BaselineRelayRequestPacket *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string BaselineRelayRequestPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: return long2string(pp->getRecipientAddress());
        case 1: return long2string(pp->getSenderAddress());
        case 2: return long2string(pp->getFormerRelayAddress());
        case 3: return long2string(pp->getRSSI());
        default: return "";
    }
}

bool BaselineRelayRequestPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: pp->setRecipientAddress(string2long(value)); return true;
        case 1: pp->setSenderAddress(string2long(value)); return true;
        case 2: pp->setFormerRelayAddress(string2long(value)); return true;
        case 3: pp->setRSSI(string2long(value)); return true;
        default: return false;
    }
}

const char *BaselineRelayRequestPacketDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *BaselineRelayRequestPacketDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
Register_Class(BaselineRelayAcceptPacket);

BaselineRelayAcceptPacket::BaselineRelayAcceptPacket(const char *name, int kind) : ::BaselineMacPacket(name,kind)
{
    this->recipientAddress_var = 0;
    this->senderAddress_var = 0;
    this->RSSI_to_Hub_var = 0;
    this->RSSI_to_node_var = 0;
}

BaselineRelayAcceptPacket::BaselineRelayAcceptPacket(const BaselineRelayAcceptPacket& other) : ::BaselineMacPacket(other)
{
    copy(other);
}

BaselineRelayAcceptPacket::~BaselineRelayAcceptPacket()
{
}

BaselineRelayAcceptPacket& BaselineRelayAcceptPacket::operator=(const BaselineRelayAcceptPacket& other)
{
    if (this==&other) return *this;
    ::BaselineMacPacket::operator=(other);
    copy(other);
...
void BaselineRelayAcceptPacket::copy(const BaselineRelayAcceptPacket& other)
{
    this->recipientAddress_var = other.recipientAddress_var;
    this->senderAddress_var = other.senderAddress_var;
    this->RSSI_to_Hub_var = other.RSSI_to_Hub_var;
    this->RSSI_to_node_var = other.RSSI_to_node_var;
}

void BaselineRelayAcceptPacket::parsimPack(cCommBuffer *b)
{
    ::BaselineMacPacket::parsimPack(b);
    doPacking(b,this->recipientAddress_var);
    doPacking(b,this->senderAddress_var);
    doPacking(b,this->RSSI_to_Hub_var);
    doPacking(b,this->RSSI_to_node_var);
}

void BaselineRelayAcceptPacket::parsimUnpack(cCommBuffer *b)
{
    ::BaselineMacPacket::parsimUnpack(b);
    doUnpacking(b,this->recipientAddress_var);
    doUnpacking(b,this->senderAddress_var);
    doUnpacking(b,this->RSSI_to_Hub_var);
    doUnpacking(b,this->RSSI_to_node_var);
}

int BaselineRelayAcceptPacket::getRecipientAddress() const
{
    return recipientAddress_var;
}

void BaselineRelayAcceptPacket::setRecipientAddress(int recipientAddress)
{
    this->recipientAddress_var = recipientAddress;
}

int BaselineRelayAcceptPacket::getSenderAddress() const
{
    return senderAddress_var;
}

void BaselineRelayAcceptPacket::setSenderAddress(int senderAddress)
{
    this->senderAddress_var = senderAddress;
}

int BaselineRelayAcceptPacket::getRSSI_to_Hub() const
{
    return RSSI_to_Hub_var;
}

void BaselineRelayAcceptPacket::setRSSI_to_Hub(int RSSI_to_Hub)
{
    this->RSSI_to_Hub_var = RSSI_to_Hub;
}

int BaselineRelayAcceptPacket::getRSSI_to_node() const
{
    return RSSI_to_node_var;
}

void BaselineRelayAcceptPacket::setRSSI_to_node(int RSSI_to_node)
{
    this->RSSI_to_node_var = RSSI_to_node;
}

class BaselineRelayAcceptPacketDescriptor : public cClassDescriptor
{
  public:
    BaselineRelayAcceptPacketDescriptor();
    virtual ~BaselineRelayAcceptPacketDescriptor();
...
Register_ClassDescriptor(BaselineRelayAcceptPacketDescriptor);

BaselineRelayAcceptPacketDescriptor::BaselineRelayAcceptPacketDescriptor() : cClassDescriptor("BaselineRelayAcceptPacket", "BaselineMacPacket")
{
}

BaselineRelayAcceptPacketDescriptor::~BaselineRelayAcceptPacketDescriptor()
{
}

bool BaselineRelayAcceptPacketDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<BaselineRelayAcceptPacket *>(obj)!=NULL;
}

const char *BaselineRelayAcceptPacketDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int BaselineRelayAcceptPacketDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 4+basedesc->getFieldCount(object) : 4;
}

unsigned int BaselineRelayAcceptPacketDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *BaselineRelayAcceptPacketDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int BaselineRelayAcceptPacketDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='r' && strcmp(fieldName, "recipientAddress")==0) return base+0;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderAddress")==0) return base+1;
    if (fieldName[0]=='R' && strcmp(fieldName, "RSSI_to_Hub")==0) return base+2;
    if (fieldName[0]=='R' && strcmp(fieldName, "RSSI_to_node")==0) return base+3;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}

const char *BaselineRelayAcceptPacketDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *BaselineRelayAcceptPacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int BaselineRelayAcceptPacketDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    BaselineRelayAcceptPacket *pp = (BaselineRelayAcceptPacket *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string BaselineRelayAcceptPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: return long2string(pp->getRecipientAddress());
        case 1: return long2string(pp->getSenderAddress());
        case 2: return long2string(pp->getRSSI_to_Hub());
        case 3: return long2string(pp->getRSSI_to_node());
        default: return "";
    }
}

bool BaselineRelayAcceptPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0: pp->setRecipientAddress(string2long(value)); return true;
        case 1: pp->setSenderAddress(string2long(value)); return true;
        case 2: pp->setRSSI_to_Hub(string2long(value)); return true;
        case 3: pp->setRSSI_to_node(string2long(value)); return true;
        default: return false;
    }
}

const char *BaselineRelayAcceptPacketDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *BaselineRelayAcceptPacketDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
Register_Class(BaselineRelayRefusePacket);

BaselineRelayRefusePacket::BaselineRelayRefusePacket(const char *name, int kind) : ::BaselineMacPacket(name,kind)
{
    this->recipientAddress_var = 0;
    this->senderAddress_var = 0;
}

BaselineRelayRefusePacket::BaselineRelayRefusePacket(const BaselineRelayRefusePacket& other) : ::BaselineMacPacket(other)
{
    copy(other);
}

BaselineRelayRefusePacket::~BaselineRelayRefusePacket()
{
}

BaselineRelayRefusePacket& BaselineRelayRefusePacket::operator=(const BaselineRelayRefusePacket& other)
{
    if (this==&other) return *this;
    ::BaselineMacPacket::operator=(other);
    copy(other);
...
void BaselineRelayRefusePacket::copy(const BaselineRelayRefusePacket& other)
{
    this->recipientAddress_var = other.recipientAddress_var;
    this->senderAddress_var = other.senderAddress_var;
}

void BaselineRelayRefusePacket::parsimPack(cCommBuffer *b)
{
    ::BaselineMacPacket::parsimPack(b);
    doPacking(b,this->recipientAddress_var);
    doPacking(b,this->senderAddress_var);
...
void BaselineRelayRefusePacket::parsimUnpack(cCommBuffer *b)
{
    ::BaselineMacPacket::parsimUnpack(b);
    doUnpacking(b,this->recipientAddress_var);
    doUnpacking(b,this->senderAddress_var);
...
int BaselineRelayRefusePacket::getRecipientAddress() const
{
    return recipientAddress_var;
}

void BaselineRelayRefusePacket::setRecipientAddress(int recipientAddress)
{
    this->recipientAddress_var = recipientAddress;
}

int BaselineRelayRefusePacket::getSenderAddress() const
{
    return senderAddress_var;
}

void BaselineRelayRefusePacket::setSenderAddress(int senderAddress)
{
    this->senderAddress_var = senderAddress;
}

class BaselineRelayRefusePacketDescriptor : public cClassDescriptor
{
  public:
    BaselineRelayRefusePacketDescriptor();
    virtual ~BaselineRelayRefusePacketDescriptor();
...
Register_ClassDescriptor(BaselineRelayRefusePacketDescriptor);

BaselineRelayRefusePacketDescriptor::BaselineRelayRefusePacketDescriptor() : cClassDescriptor("BaselineRelayRefusePacket", "BaselineMacPacket")
{
}

BaselineRelayRefusePacketDescriptor::~BaselineRelayRefusePacketDescriptor()
{
}

bool BaselineRelayRefusePacketDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<BaselineRelayRefusePacket *>(obj)!=NULL;
}

const char *BaselineRelayRefusePacketDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int BaselineRelayRefusePacketDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 2+basedesc->getFieldCount(object) : 2;
}

unsigned int BaselineRelayRefusePacketDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *BaselineRelayRefusePacketDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int BaselineRelayRefusePacketDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='r' && strcmp(fieldName, "recipientAddress")==0) return base+0;
...
const char *BaselineRelayRefusePacketDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *BaselineRelayRefusePacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int BaselineRelayRefusePacketDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    BaselineRelayRefusePacket *pp = (BaselineRelayRefusePacket *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string BaselineRelayRefusePacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool BaselineRelayRefusePacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *BaselineRelayRefusePacketDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *BaselineRelayRefusePacketDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
